...
unrestricted state-to-portfolio map. For the costly problem, the frictionless solution is used as an advanced start so that Stage~2 learns a correction around an economically meaningful benchmark rather than the full policy from scratch.
